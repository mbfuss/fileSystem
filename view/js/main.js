...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const fetchAndUpdateTable = () => {
        ...
        fetchData(currentRoot, sortOrder, (data) => updateTable(data, fileTableBody, navigateToDirectory(currentRoot, setCurrentRoot, fetchAndUpdateTable)), currentPath);
    };

    // Добавляем обработчики событий к элементам управления.
    addEventHandlers(sortOrderSlider, cancelButton, fetchAndUpdateTable, navigateBack(currentRoot, setCurrentRoot, fetchAndUpdateTable), currentRoot);
